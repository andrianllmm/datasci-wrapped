    ...
    <Slide>
      <div className="w-full h-full flex flex-col items-center justify-center">
        <ScrollAnimate animation={() => fadeInUp()}>
          <h1 className="text-center text-2xl md:text-5xl sm:text-4xl font-black text-white mb-4 flex flex-wrap items-center justify-center gap-3">
            We seem to love{" "}
            <span className="text-purple-200">{data.tools[0].tool}</span> so
            much...
          </h1>
        </ScrollAnimate>
